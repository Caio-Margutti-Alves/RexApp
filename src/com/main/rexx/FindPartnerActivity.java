...
GooglePlayServicesClient.OnConnectionFailedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnAddress = (Button) findViewById(R.id.getAddress);
		btnAddress.setOnClickListener(btnListenerAddress);
		
		endereco = (TextView) findViewById(R.id.endereco);
		latLng = (TextView) findViewById(R.id.lat_long);
		progressBar = (ProgressBar) findViewById(R.id.barProgresso);
    ...
    public void getLocation(View v) {
        ...
        if (servicesConnected()) {
            ...
            latLng.setText(LocationUtils.getLatLng(this, currentLocation));
        }
    }
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new FindPartnerActivity.GetAddressTask(this)).execute(currentLocation);
        }
    }
