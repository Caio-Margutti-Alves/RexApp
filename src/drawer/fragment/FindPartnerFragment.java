...
public class FindPartnerFragment extends Fragment implements
LocationListener,
...
GooglePlayServicesClient.OnConnectionFailedListener {
	...
	Button.OnClickListener btnListenerAddress = new Button.OnClickListener() {
		@Override
	...
	public FindPartnerFragment newInstance(String text){
		FindPartnerFragment mFragment = new FindPartnerFragment();		
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		btnAddress = (Button) rootView.findViewById(R.id.getAddress);
		btnAddress.setOnClickListener(btnListenerAddress);
		
		endereco = (TextView) rootView.findViewById(R.id.endereco);
		latLng = (TextView) rootView.findViewById(R.id.lat_long);
		progressBar = (ProgressBar) rootView.findViewById(R.id.barProgresso);
		...
		mPrefs = this.getActivity().getSharedPreferences(LocationUtils.SHARED_PREFERENCES,
	...
	private boolean servicesConnected() {
		...
		if (ConnectionResult.SUCCESS == resultCode) {
			...
			if (dialog != null) {
				...
				//errorFragment.show(getActivity().getsFragmentManager(),
    ...
    public void getLocation(View v) {
        ...
        if (servicesConnected()) {
            ...
            latLng.setText(LocationUtils.getLatLng(this.getActivity(), currentLocation));
        }
    }
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new FindPartnerFragment.GetAddressTask(this.getActivity())).execute(currentLocation);
        }
    }
	...
	public void onLocationChanged(Location location) {
		...
		status.setText(R.string.location_updated);

		// In the UI, set the latitude and longitude to the value received
		latLng.setText(LocationUtils.getLatLng(this.getActivity(), location));
	}
	...
	private void startPeriodicUpdates() {
		...
		state.setText(R.string.location_requested);
	}
	...
	private void stopPeriodicUpdates() {
		...
		state.setText(R.string.location_updates_stopped);
	}
	...
	private void showErrorDialog(int errorCode) {
		...
		Dialog errorDialog = GooglePlayServicesUtil.getErrorDialog(errorCode,
				this.getActivity(), LocationUtils.CONNECTION_FAILURE_RESOLUTION_REQUEST);
