...
GooglePlayServicesClient.OnConnectionFailedListener {
	...
	static private TextView mAddress;
	static private TextView mLatLng;
	static private ProgressBar mActivityIndicator;
	static private TextView mConnectionState;
	...
	public GPSActivity(TextView txtvEndereco, TextView txtvLatLng, ProgressBar progresso,
						TextView txtvState, TextView txtvStatus, Context context) {
		super();
		GPSActivity.mAddress = txtvEndereco;
		GPSActivity.mLatLng = txtvLatLng;
		GPSActivity.mActivityIndicator = progresso;
		GPSActivity.mConnectionState = txtvState;
		GPSActivity.mConnectionStatus = txtvStatus;
		GPSActivity.context = context;
	}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mLatLng = (TextView) findViewById(R.id.lat_long);
		mAddress = (TextView) findViewById(R.id.endereco);
		mActivityIndicator = (ProgressBar) findViewById(R.id.barProgresso);
    ...
    public void getAddress(View v) {
        ...
        if (servicesConnected()) {
            ...
            (new GPSActivity.GetAddressTask(this)).execute(currentLocation);
        }
    }
